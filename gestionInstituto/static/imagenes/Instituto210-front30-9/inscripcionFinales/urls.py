...
urlpatterns = [
    ...
    path('materias/abrir_materias_seleccionadas/', abrir_materias_seleccionadas, name='abrir_materias_seleccionadas'),
    path('materias/cerrar_materias_seleccionadas/', cerrar_materias_seleccionadas, name='cerrar_materias_seleccionadas'),
