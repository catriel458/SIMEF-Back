<<<<<<< HEAD
# Generated by Django 5.2.3 on 2025-09-25 22:47
=======
# Generated by Django 4.2.6 on 2025-09-25 21:34
>>>>>>> Simef-Hernan-Sofi
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modalidad', models.CharField(blank=True, choices=[('01', 'Oyente'), ('02', 'Regular'), ('03', 'Itinerante')], max_length=20, null=True, verbose_name='Modalidad')),
                ('ciclo_lectivo', models.CharField(blank=True, max_length=100, null=True, verbose_name='Ciclo lectivo')),
                ('institucion', models.CharField(blank=True, max_length=100, null=True, verbose_name='Institución')),
                ('turno', models.CharField(blank=True, choices=[('Mañana', 'Mañana'), ('Tarde', 'Tarde'), ('Noche', 'Noche')], max_length=20, null=True, verbose_name='Turno')),
                ('materia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inscripcionFinales.materia')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
